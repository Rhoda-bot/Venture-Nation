    ...
    return(
        <>
            ...
            <div className="my-2  px-1 pl-2 border-0">
                    <h6 className="fw-bold contact--title mb-3">Contact info</h6>
                    <div className="">
                        <i className="fa fa-phone"/> <span className="mx-3 contact--span">Phone </span>
                        <p className="mx-4 px-2 contact--text">{user && user?.phone}</p>

                    </div>
                    <div className="">
                        <i className="fa fa-message"/> <span className="mx-3">Email Address </span>
                        <p className="mx-4 px-2 contact--text">{user && user?.email}</p>
